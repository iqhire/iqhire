...
<div class="row">
	<div class="span8 cushycms" title="Content">
		...
		<div class="hr">
			<h3>Adverse Action Procedures</h3>
			...
			<h4>Step 2</h4>
			<p>After you've taken an adverse action, you must give the individual notice orally, in writing, or electronically - that the action has been taken in an adverse action notice. It must include:</p>
			<ul>
				<li>The name, address, and phone number of Inquirehire.</li>
